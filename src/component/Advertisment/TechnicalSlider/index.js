    ...
    <Row className="align-items-center">
      ...
      <Col xl={6} lg={5}>
        ...
        >
          ...
          <div>
            <h3>
              Unity, C#, JavaScript, Python, WebGl platform, unity network for
              all platform (android, IOS, mac)
            </h3>
          </div>
          <div>
            <h3>
              Ethereum, Solidity, Solana, Cosmos SDK, DAPP development, DX,
              DeFi, Blockchain, Hyperledger, NFT Marketplacem NFR Minring, Smart
              Contracts.
            </h3>
          </div>
          <div>
            <h3>
              HDFS, YARN, Parquet, Impala, Presto, Drill, RCNN-family, SSD,
              Retina Net, YOloV1, VGG, ResNet, Inception, DenseNets, TensorFlowm
              Keras, MxNet, Caffe2m Naive Bayes, Hardware, Firemware, QT, BLE,
              C++, PCB design, 3D printing.
            </h3>
          </div>
          <div>
            <h3>
